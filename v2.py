...
try:
    ...
    st.error(f"無法導入 ta-lib-bin，可能缺少 ta-lib-bin 或 pkg_resources：{e}")
    st.warning("DMI/ADX 訊號將被禁用，請安裝 ta-lib-bin（pip install ta-lib-bin）或參見 https://github.com/TA-Lib/ta-lib-python")
    talib = None
